...
if (game.ask("Drink the iced tea", "walk 10 miles")) {
    scene.setBackgroundImage(img`
        ...
        ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        `)
    game.showLongText("The iced tea made you even more thirsty,you die", DialogLayout.Bottom)
    game.over(false)
} else {
    scene.setBackgroundImage(img`
        9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
    ...
    mySprite = sprites.create(img`
        ...
        . . f f c c c c c c c c . . . . 
        `, SpriteKind.Player)
    game.showLongText("The Snake says:\"Give me something ", DialogLayout.Bottom)
    if (game.ask("Give the Snake $2", "Gice the Snake iced tea")) {
        gameOver("The Snake eats you")
    } else {
        game.showLongText("Thank you. Can I be your pet?", DialogLayout.Bottom)
        if (game.ask("Yes", "No")) {
            scene.setBackgroundImage(img`
                
